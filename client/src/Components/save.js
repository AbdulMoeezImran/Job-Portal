...
export default function NavBar() {
  ...
  return (
    <>
      <div className="sticky top-0 inset-x-0 z-[1000] min-h-20 flex items-center justify-between bg-indigo-600 text-white px-6 max-lg:flex-col max-lg:flex-wrap">
        <div className="px-2 h-20 flex items-center justify-between max-lg:w-full">
        ...
        <div
          className={`px-2 h-full items-center justify-center flex max-lg:flex-col gap-x-14 gap-y-8 ${
            !isOpen && "max-lg:hidden"
          }`}
        >
          <Link
            href={"/"}
            className="text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase"
          >
            Home
          </Link>
          <Link
        ...
        <div
          className={`px-2 h-full items-center justify-center flex max-lg:mt-6 max-lg:mb-2 ${
            !isOpen && "max-lg:hidden"
          }`}
        >
          {userInfo !== null ? (
